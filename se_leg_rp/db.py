...
from eduid_userdb.proofing.proofingdb import ProofingStateDB
from eduid_userdb.proofing.proofing_state import OidcProofingState
...
class ProofDB(BaseDB):
    ...
    def __init__(self, db_uri, db_name='se_leg_rp', collection='proofs'):
...
class OidcProofingStateDB(ProofingStateDB):
    ...
    def __init__(self, db_uri, db_name='se_leg_rp'):
